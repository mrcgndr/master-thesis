...
To visualize the four questions, figure \ref{deteff:1d_example} shows a 1D example.
...
\end{align}
which yields to a detection efficiency value for each SiPM $i$, wavelength range $\Delta\lambda$, and HEALPix $\text{HP}$.
