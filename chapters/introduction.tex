...
\end{align}
introducing a spectral index $\gamma$ which is dependent from the considered energy region.\todo{in welchen Regionen welcher Spektralindex?}
...
\begin{figure}[H]
	...
	\caption[short caption]{\textbf{short caption.}~\cite{iacts:cta_artwork} long caption}
	\label{label}
\end{figure}
