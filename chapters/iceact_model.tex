...
An SiPM is the composition of an array of so called \textit{Geiger-mode avalanche photo diodes} (\text{G-APD}s). Their working principle is based on p-n junctions (cf. figure \ref{sipm:pn_junction})

\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{PNJunction.pdf}
	\caption[Sketch of a p-n-junction]{\textbf{Sketch of a p-n-junction.} \cite{iceact:camera} }
