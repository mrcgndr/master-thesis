...
The \iceact telescopes use a light collection technique to enlarge the detection area of the SiPM grid based on \textit{compound parabolic concentrators} (\textit{CPC}s) \cite{wico:book}. In the following, this concentrators are named \textit{Winston cones}. 
