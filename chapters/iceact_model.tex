...
\end{figure}
\todo{sind die blind pixels wirklich blind (abgeklebt)?}
...
The IceAct telescopes use a light collection technique to enlarge the detection area of the SiPM grid based on so called \textit{Winston cones} (or originally \textit{parabolic concentrator} \cite{wico:book}). 
